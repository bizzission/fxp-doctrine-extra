 ...
 */
class ManagerUtilsTest extends TestCase
{
    ...
    public function testGetManagerWithValidClass()
    {
        /* @var ClassMetadataFactory|MockObject $metaFactory */
        $metaFactory = $this->getMockBuilder(ClassMetadataFactory::class)->getMock();
    ...
    public function testGetManagerWithValidClassButMappedSupperclass()
    {
        /* @var ClassMetadataFactory|MockObject $metaFactory */
        $metaFactory = $this->getMockBuilder(ClassMetadataFactory::class)->getMock();
        ...
        /* @var OrmClassMetadata|MockObject $registry */
